    ...
    <section class="sign-in">
        <div class="container">
            <div class="signin-form">
                <h2 class="form-title">Welcome, <%= request.getSession().getAttribute("username")%>
                </h2>
                <form action="/user/logout" method="POST" class="register-form" id="form">
                    <ul>
                        <li>First name: <%= request.getSession().getAttribute("firstName")%>
                        </li>
                        <li>Last name: <%= request.getSession().getAttribute("lastName")%>
                        </li>
                ...
                <form action="/management">
                    <div class="form-group form-button">
                        <input type="submit" name="signin" class="form-submit" value="Manage users"/>
                    </div>
                </form>
                <form action="/user/logout" method="POST" class="register-form" id="logout-form">
                    <div class="form-group form-button">
