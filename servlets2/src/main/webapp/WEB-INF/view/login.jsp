        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure><img src="../../AccessPages/images/signin-image.jpg" alt="sing up image"></figure>
                    <a href="<c:url value="/user/register"/>" class="signup-image-link">Create an account</a>
                </div>
